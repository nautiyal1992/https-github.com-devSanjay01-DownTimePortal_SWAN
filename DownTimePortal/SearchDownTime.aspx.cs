...
public partial class SearchDownTime : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
            ...
            //Calculatedwntime();
   //DateTime fdy = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day-1);
    ...
    void Loaddata()
    {
       ...
       string gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2";
    ...
    void LoadDHQ()
    {
     ...
     //   DropDownList1.Items[0].Value = "";
            SqlConnection con = new SqlConnection(str);
            String DHQ = "Select DISTINCT DHQ from DHQ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(str);
        string gdata = null;
            if (DropDownList1.SelectedItem.Text == "Select All" && DropDownList2.SelectedItem.Text == "Select All" &&  DropDownList4.SelectedItem.Text == "Select All")
            {
                 gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%'" ;     
             }
            else if (DropDownList1.SelectedItem.Text == "Select All" && DropDownList2.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND Bandwidth=@bwth";
            }
            else if (DropDownList1.SelectedItem.Text == "Select All" && DropDownList4.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND B_End=@bnd";
            }
            else if (DropDownList2.SelectedItem.Text == "Select All" && DropDownList4.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND A_End=@aend";
               
             }
            else if (DropDownList1.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' B_End=@bnd AND Bandwidth=@bwth";
                
            }
            else if (DropDownList2.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND A_End=@aend AND Bandwidth=@bwth";
              
            }
            else if (DropDownList4.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND A_End=@aend AND B_End=@bnd AND Reason like @rsn +'%'";
            }
            else
            {
                gdata = "select * from Downdetail where LLDown_Date BETWEEN @dt1 AND @dt2 AND A_End=@aend AND B_End=@bnd AND Bandwidth=@bwth AND Reason like @rsn + '%' ";
          ...
          else
          {
              SqlDataAdapter adp = new SqlDataAdapter(gdata, con);
              SqlCommandBuilder cmd = new SqlCommandBuilder(adp);
              cmd.DataAdapter.SelectCommand.Parameters.AddWithValue("@aend", DropDownList1.SelectedItem.Value);
