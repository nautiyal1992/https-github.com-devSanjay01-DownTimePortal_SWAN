...
<asp:Content ID="Content9" runat="server" ContentPlaceHolderID="ContentPlaceHolder9">
    <asp:TreeView ID="TreeView1" runat="server" Font-Size="Small">
        <Nodes>
            ...
            <asp:TreeNode NavigateUrl="~/DHQ/DistrictDownDetail.aspx" 
                Text="District Downtime" Value="District Downtime">
            </asp:TreeNode>
            <asp:TreeNode Text="Report" Value="Report" NavigateUrl="~/DHQ/Report.aspx"></asp:TreeNode>
