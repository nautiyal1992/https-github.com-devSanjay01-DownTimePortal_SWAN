<%@ page title="" language="C#" masterpagefile="~/UserMaster.master" autoeventwireup="true" inherits="DHQHome, App_Web_xjen1rsy" %>
        ...
        <tr>
            <td class="style5" colspan="15" align="center" width="100%">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    CellPadding="3" PageSize="30" ShowHeaderWhenEmpty="True" OnRowDeleting="GridView1_RowDeleting"
...
<asp:Content ID="Content10" runat="server" ContentPlaceHolderID="ContentPlaceHolder9">
    <asp:TreeView ID="TreeView1" runat="server" Font-Size="Small">
        ...
        <Nodes>
            ...
            <asp:TreeNode Text="District Downtime" Value="District Downtime" NavigateUrl="~/DistrictDownDetail.aspx">
            </asp:TreeNode>
            <asp:TreeNode NavigateUrl="~/Report.aspx" Text="Report" Value="Generate"></asp:TreeNode>
        </Nodes>
    </asp:TreeView>
</asp:Content>
