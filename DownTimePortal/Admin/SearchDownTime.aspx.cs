...
public partial class SearchDownTime : System.Web.UI.Page
{
   ...
   //DateTime fdy = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day-1);
    ...
    void Loaddata()
    {
       ...
       string gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string gdata = null;
            ...
            {
                 gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%'" ;     
             }
            else if (DropDownList1.SelectedItem.Text == "Select All" && DropDownList2.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND Bandwidth=@bwth";
            }
            else if (DropDownList1.SelectedItem.Text == "Select All" && DropDownList4.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND B_End=@bnd";
            }
            else if (DropDownList2.SelectedItem.Text == "Select All" && DropDownList4.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND A_End=@aend";
               
             }
            else if (DropDownList1.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' B_End=@bnd AND Bandwidth=@bwth";
                
            }
            else if (DropDownList2.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2 AND Reason like @rsn + '%' AND A_End=@aend AND Bandwidth=@bwth";
              
            }
            else if (DropDownList4.SelectedItem.Text == "Select All")
            {
                gdata = "select * from Downdetail where LLUP_Date BETWEEN @dt1 AND @dt2 AND A_End=@aend AND B_End=@bnd AND Reason like @rsn +'%'";
            }
            else
            {
