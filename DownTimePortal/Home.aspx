<%@ page title="" language="C#" masterpagefile="~/UserMaster.master" autoeventwireup="true" inherits="Home, App_Web_xjen1rsy" %>
        ...
        <tr>
            <td class="style5" colspan="15" align="center" width="100%">
                <asp:GridView ID="GridView1" runat="server" Width="100%" 
                    ...
                    DataSourceID="Downtimesource" AllowPaging="True" CellPadding="4" 
                    ...
                    BorderColor="#336666" BorderStyle="Double" BorderWidth="3px"  >
                     ...
                     <RowStyle BackColor="White" HorizontalAlign="Center" CssClass="row" 
                         ForeColor="#333333" />
